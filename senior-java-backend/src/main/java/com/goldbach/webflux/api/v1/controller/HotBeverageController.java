...
public class HotBeverageController {
    ...
    @PostMapping
    public ResponseEntity<Object> createVehicle(@RequestBody HotBeverageRequest req) {
        try {
            HotBeverageDto vehicleDto = new HotBeverageBuilder(HotBeverageType.valueOf(req.getHotDrinkName()))
                    .withMilk(req.getWithMilk())
                    .withSugar(req.getWithSugar())
                    .build();
            ServiceResponseDto<HotBeverageDto> response = hotBeverageService.createHotBeverage(vehicleDto);
    ...
    @GetMapping("/{id}")
    public ResponseEntity<HotBeverageDto> getVehicleById (@PathVariable("id") int id) {
    ...
    @GetMapping
    public ResponseEntity<List<HotBeverageDto>> getVehicleList () {
    ...
    @PutMapping
    public ResponseEntity<Object> updateVehicle(@RequestBody HotBeverageRequest req) {
        try {
    ...
    @DeleteMapping("/{id}")
    public ResponseEntity<HotBeverageDto> deleteVehicleById (@PathVariable("id") int id) {
